                        ...
                        <div class="col-lg-12  w-100">
                            <div class="row">
                                ...
                                <div class="text-end col-sm-3 pt-4">
                                    ...
                                    <button class="btn {{$in_status!=0?'btn-success':'btn-warning'}} m-1 mt-1" type="button"  data-toggle="modal" {{$in_status!=0?'data-target="#TambahData"':'data-target="alert"'}} id="modal-button"><i class="fas fa-plus m-1"></i> {{__('add data')}}</button>
                                    </div>                                
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="modal-barang" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal fade" id="TambahData" aria-labelledby="TambahDataModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="TambahDataModalLabel">{{__("create an return transaction")}}</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="kode" class="form-label">{{__("return item code")}}<span class="text-danger">*</span></label>
                                        <input type="text" name="kode" readonly class="form-control">
                                        <input type="hidden" name="id"/>
                                        <input type="hidden" name="id_barang"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal_retur" class="form-label">{{__("return date")}} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <label for="jumlah" class="form-label">{{__("returned amount")}}<span class="text-danger">*</span></label>
...
<script>
    ...
    function ubah(){
        ...
        $.ajax({
            ...
            type:"put",
            data:{id,item_id,user_id,date_retur,customer_id,invoice_number,quantity},
            success:function(res){
                    Swal.fire({
                        position: "center",
                        icon: "success",
